...
import EnrollModal from '../../Components/EnrollRelated/EnrollModal/EnrollMoad';
                        ...
                        <div id="profile" className="w-full mx-6 bg-white rounded-lg shadow-2xl opacity-75 lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none lg:mx-0">
                            ...
                            <div className="p-4 text-center md:p-12 lg:text-left">
                                ...
                                <div className="pt-12 pb-8">
                                    <button onClick={()=>setIsOpen(true)} className="btn btn-primary btn-outline">Enroll</button>
                                </div>

                                <EnrollModal closeModal={closeModal} isOpen={isOpen} studentInfo={studentInfo}></EnrollModal>
