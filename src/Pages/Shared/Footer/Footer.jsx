...
const Footer = () => {
      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap justify-between -mx-4">
          ...
          <div className="w-full px-4 my-4 sm:w-auto">
            <div>
              <h2 className="inline-block pb-4 mb-4 text-2xl border-b-4 border-blue-600">Company</h2>
            </div>
          ...
          <div className="w-full px-4 my-4 sm:w-auto">
            <div>
              <h2 className="inline-block pb-4 mb-4 text-2xl border-b-4 border-blue-600">Blog</h2>
            </div>
            <ul className="leading-8">
    ...
    <div className="py-4 text-gray-100 bg-indigo-700">
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap justify-between -mx-4">
